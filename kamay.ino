...
void loop() {     // repeat in a loop
  ...
  prizm.setServoPosition(5,45);  // rotate servo1 to 180 degrees
  delay(2000);                    // wait for 3 seconds to give servo1 time
                                  // to get to position 180
  prizm.setServoPosition(5,90);    // rotate servo1 to 0 degrees
  delay(2000);                    // wait for 3 seconds to give servo1 time
